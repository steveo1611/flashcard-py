...
USE mysql;
CREATE DATABASE
IF NOT EXISTS flashcards DEFAULT CHARACTER
SET utf8 ;
...
USE flashcards;
INSERT INTO cards
    (mainsubject, category, question, answer, additional_info)
VALUES
    ('zzz', 'qqqq', 'testqq1', 'testaa1', 'http://testtest'),
    ...
    ('chef', 'cookbook', 'testq1212', 'testa1212', 'http://test1212');
